...
function statusBadge(status) {
  const map = {
    ...
    fired:     { label: 'Sonando…',     cls: 'bg-blue-500/15 text-blue-300 border-blue-500/30' },
    taken:     { label: '✅ Tomado',     cls: 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30' },
    missed:    { label: '❌ No tomado',  cls: 'bg-rose-500/15 text-rose-300 border-rose-500/30' },
